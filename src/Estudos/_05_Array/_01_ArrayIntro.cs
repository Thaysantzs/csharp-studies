...
public class ArrayIntro
{
    public static void Main(string[] args)
    {
        ...
        for (int i = 0; i < numbers.Length; i++)
        {
            numbers[i] = Library.ReadInterge($"Number[{i}] ");
        }
        ...
        Console.WriteLine(names[4] == null);
        Console.WriteLine(names[5] == "Paulo");

        // This will cause an error becuase there is no index 10
