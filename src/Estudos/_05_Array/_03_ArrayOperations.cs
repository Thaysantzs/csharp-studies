...
public class ArrayOperations
{
  public static void Main(string[] args)
  {
    ...
    Library.PrintingIntArray(myArray, "myArray");
    ...
    // Sort
    Array.Sort(myArray);
    Library.PrintingIntArray(myArray, "My Array Sorted");

    // Clear
    Library.PrintingIntArray(myArrayClone, "My Array Cloned");
    Array.Clear(myArrayClone);
    Library.PrintingIntArray(myArrayClone, "My Array Cloned Cleared");

    // Copy
    int[] myArrayCopy = new int[myArray.Length];
    Library.PrintingIntArray(myArrayCopy, "Before copy");
    Array.Copy(myArray, myArrayCopy, myArray.Length);
    Library.PrintingIntArray(myArrayCopy, "After copy");
    ...
    // Reverse
    Library.PrintingIntArray(myArray);
    Array.Reverse(myArray);
    Library.PrintingIntArray(myArray, "myArray Reversed");
    ...
    Library.PrintingIntArray(myNewArray);
    Library.PrintingIntArray(myNewArrayDistinct);
    ...
    Library.PrintingIntArray(greaterThan5, "Greater than 5");
    Library.PrintingIntArray(myArray2, "myArray2");
